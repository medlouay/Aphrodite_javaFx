        ...
        int row = 1;
          ...
          try {
            ...
            for (Comment cmnts :list){
                ...
                loader.setLocation(getClass().getResource("Comment/Pane/CommentPane.fxml"));
            ...
            public void handle(ActionEvent e) {
                ...
                String qrCodeContent = "http://localhost:8000/en/blog/posts/" + p.getSlug();
                try {
