...
public class Post {
    ...
    public Post(int id, int author_id, String title, String slug, String summary, String content, String author_name) {
        this.id = id;
    ...
    public Post(int id,String title, String author_name, String slug, String summary, String content) {
               this.id = id;
