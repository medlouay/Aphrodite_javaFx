...
public class MenuAppWithChartController implements Initializable {
    ...
    private BarChart buildBarChart() {
        ...
        xAxis.setLabel("statistique");

        NumberAxis yAxis = new NumberAxis();
        yAxis.setLabel("# of  appointment");

        BarChart barChart = new BarChart(xAxis, yAxis);

        XYChart.Series dataSeries1 = new XYChart.Series();
        dataSeries1.setName("Statistique");

        dataSeries1.getData().add(new XYChart.Data("Aproved", 2300));
        dataSeries1.getData().add(new XYChart.Data("Pending", 1000));
    ...
    private PieChart buildPieChart() {
        ...
        ObservableList<PieChart.Data> pieChartData = FXCollections.observableArrayList(
                new PieChart.Data("Aproved", 65),
                new PieChart.Data("Pending", 56));
        ...
        pieChart.setTitle(""); //Setting the title of the Pie chart
