...
public class HomeController implements Initializable {
    ...
    @FXML
    private JFXButton diagBtn;
    @FXML
    private JFXButton diagBtn1;
    @FXML
    ...
    @FXML
    private void gestionSymptome(ActionEvent event) throws IOException {
         FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/com/example/UI/Admin/diagnostics.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = new Stage(StageStyle.DECORATED);
            stage.setTitle("symptome");
            stage.setScene(scene);
            stage.show();
            closeStage();
    }
    ...
    private void gestionReclamations(ActionEvent event) throws IOException {
          FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/com/example/UI/Admin/reponse1.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = new Stage(StageStyle.DECORATED);
            stage.setTitle("symptome");
            stage.setScene(scene);
    ...
    private void gestionPosts(ActionEvent event) throws IOException {
                        Parent fxml = FXMLLoader.load(getClass().getResource("show_post.fxml"));
    ...
    private void gestionComment(ActionEvent event) throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("Show_Comment.fxml"));
        contentArea.getChildren().removeAll();
        contentArea.getChildren().setAll(fxml);
    }
