...
public class ResultController implements Initializable {
    ...
    int diagnostic_id = Aphrodite.id_diagselect;
        ...
        alert.showAndWait();
         String adressemail = "yasminegheribi04@gmail.com";
         String sujet = "Urgence";
         String motif = "Un Cas d'urgence s'est approuvé !";
    ...
    private void retour(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("diagnostics.fxml"));
