...
public class CalendarController implements Initializable {
    ...
    private Map<Integer, List<CalendarActivity>> getCalendarActivitiesMonth(ZonedDateTime dateFocus) {
        ...
        List<Appointment> applist = aps.afficher();
        for ( Appointment a : applist ){
        int yearq = a.getAppointmentdate().getYear();
        int monthq = a.getAppointmentdate().getMonthValue();
        int day = a.getAppointmentdate().getDayOfMonth();
        int hour = a.getAppointmentime().getHour();
        int minute = a.getAppointmentime().getMinute();

       
            ZonedDateTime time = ZonedDateTime.of(yearq, a.getAppointmentdate().getMonthValue(), day,hour,minute,0,0,dateFocus.getZone());
            calendarActivities.add(new CalendarActivity(time, a.getName()));
